...
class Template
{
	...
	public function load()
	{
		...
		if (file_exists($pathFileConfig)) {
			...
			$view->_pluginCssFiles  = $view->createLink($this->_folderTemplate . $arrConfig['dirPlugins'], $arrConfig['filePluginsCss'], 'css');
			$view->_pluginJsFiles 	= $view->createLink($this->_folderTemplate . $arrConfig['dirPlugins'], $arrConfig['filePluginsJs'], 'js');
